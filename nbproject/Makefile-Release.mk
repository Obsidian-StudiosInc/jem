...
${OBJECTDIR}/src/env_manager.o: src/env_manager.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/env_manager.o src/env_manager.c

${OBJECTDIR}/src/file_parser.o: src/file_parser.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_parser.o src/file_parser.c
...
${OBJECTDIR}/src/output_formatter.o: src/output_formatter.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/output_formatter.o src/output_formatter.c

${OBJECTDIR}/src/package.o: src/package.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/package.o src/package.c

${OBJECTDIR}/src/vm.o: src/vm.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vm.o src/vm.c
...
${OBJECTDIR}/src/env_manager_nomain.o: ${OBJECTDIR}/src/env_manager.o src/env_manager.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/env_manager_nomain.o src/env_manager.c;\
	else  \
...
${OBJECTDIR}/src/file_parser_nomain.o: ${OBJECTDIR}/src/file_parser.o src/file_parser.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_parser_nomain.o src/file_parser.c;\
	else  \
...
${OBJECTDIR}/src/output_formatter_nomain.o: ${OBJECTDIR}/src/output_formatter.o src/output_formatter.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/output_formatter_nomain.o src/output_formatter.c;\
	else  \
...
${OBJECTDIR}/src/package_nomain.o: ${OBJECTDIR}/src/package.o src/package.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/package_nomain.o src/package.c;\
	else  \
...
${OBJECTDIR}/src/vm_nomain.o: ${OBJECTDIR}/src/vm.o src/vm.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vm_nomain.o src/vm.c;\
	else  \
